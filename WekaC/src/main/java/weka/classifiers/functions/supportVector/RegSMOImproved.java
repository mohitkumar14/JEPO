...
public class RegSMOImproved extends RegSMO implements
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (tmpStr.length() != 0) {
      setTolerance(Float.parseFloat(tmpStr));
    } else {
      setTolerance(0.001f);
    }
  ...
  public String[] getOptions() {
    ...
    result.add("-T");
    result.add(String.valueOf(getTolerance()));
   ...
   */
  public void setTolerance(float d) {
    m_fTolerance = d;
  }
   ...
   * @throws Exception
   */
  protected void updateIndexSetFor(int i, float C) throws Exception {
    /*
   ...
   */
  protected void updateBoundaries(int i2, float F2) {
    int iSet = m_iSet[i2];
