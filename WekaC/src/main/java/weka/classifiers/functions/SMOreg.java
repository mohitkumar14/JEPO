...
public class SMOreg 
  ...
  protected float m_x1 = 1.0f;
  protected float m_x0 = 0.0f;
  ...
  public String globalInfo() {
    return
    		new StringBuilder("SMOreg implements the support vector machine for regression. "
    		).append( "The parameters can be learned using various algorithms. The "
    		).append("algorithm is selected by setting the RegOptimizer. The most "
    		).append( "popular algorithm (" 
    		).append(RegSMOImproved.class.getName().replaceAll(".*\\.", "") 
    		).append( ") is due to Shevade, Keerthi " 
    		).append( "et al and this is the default RegOptimizer.\n\n"
  ...
  public Enumeration<Option> listOptions() {
    ...
    result.addElement(new Option(new StringBuilder(
	"\tOptimizer class used for solving quadratic optimization problem\n).append(\t(default ")
    		.append(RegSMOImproved.class.getName()).append(")").toString(),
  ...
  public String[] getOptions() {
    ...
    result.add("-I");
    result.add(new StringBuilder(getRegOptimizer().getClass().getName()).append(" ").append(Utils.joinOptions(getRegOptimizer().getOptions())).toString());

    result.add("-K");
    result.add(new StringBuilder(getKernel().getClass().getName()).append(" ").append(Utils.joinOptions(getKernel().getOptions())).toString());
  ...
  public void buildClassifier(Instances instances) throws Exception {
    ...
    float y0 = instances.instance(0).classValue();
    int index = 1;
    ...
    float y1 = instances.instance(index).classValue();
    ...
    if (m_Filter != null) {
      float z0 = instances.instance(0).classValue();
      float z1 = instances.instance(index).classValue();
  ...
  public float classifyInstance(Instance instance) throws Exception {
    ...
    float result = m_optimizer.SVMOutput(instance);
   ...
   */
  protected float measureKernelEvaluations() {
    if (m_optimizer != null) {
   ...
   */
  protected float measureCacheHits() {
    if (m_optimizer != null) {
