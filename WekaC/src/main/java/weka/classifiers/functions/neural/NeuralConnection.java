...
public abstract class NeuralConnection
  ...
  protected float m_unitValue;

  /** The error value for this unit, NaN if not calculated. */
  protected float m_unitError;
   ...
   */
  public abstract float outputValue(boolean calculate);
   ...
   */
  public abstract float errorValue(boolean calculate);
