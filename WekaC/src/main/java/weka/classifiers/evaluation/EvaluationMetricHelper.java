...
public class EvaluationMetricHelper {
   ...
   * @throws Exception if the metric is not a known built-in metric
   */
  protected float getBuiltinMetricValue(int metricIndex, int... classValIndex)
    throws Exception {
   ...
   */
  protected float getPluginMetricValue(AbstractEvaluationMetric m,
   ...
   */
  public float getNamedMetric(String statName, int... classValIndex)
    throws Exception {
   ...
   * @throws Exception if the metric/stat is unknown or a problem occurs
   */
  public float[] getNamedMetricThresholds(String statName)
    throws Exception {
