...
public abstract class AbstractOutput implements Serializable, OptionHandler {
  ...
  public Enumeration<Option> listOptions() {
    ...
    result.addElement(new Option(
    		new StringBuilder("\tThe number of digits after the decimal point.\n\t(default: ")
        .append(getDefaultNumDecimals()).append(")").toString(), "decimals", 1, "-decimals <num>"));
  ...
  public String[] getOptions() {
    ...
    if (getNumDecimals() != getDefaultNumDecimals()) {
      result.add("-decimals");
      result.add(String.valueOf(getNumDecimals()));
    }
   ...
   * @throws Exception if printing of classification fails
   */
  protected abstract void doPrintClassification(float[] dist, Instance inst,
   ...
   *           classification
   */
  public void printClassification(float[] dist, Instance inst, int index)
    throws Exception {
    String error;
