...
public class Evaluation implements Summarizable, RevisionHandler, Serializable {
   ...
   */
  protected float m_Incorrect;

  /**
   * The weight of all correctly classified instances.
   */
  protected float m_Correct;

  /**
   * The weight of all unclassified instances.
   */
  protected float m_Unclassified;

  /*** The weight of all instances that had no class assigned to them. */
  protected float m_MissingClass;

  /**
   * The weight of all instances that had a class assigned to them.
   */
  protected float m_WithClass;

  /**
   * Array for storing the confusion matrix.
   */
  protected float[][] m_ConfusionMatrix;
   ...
   */
  protected float[] m_ClassPriors;

  /**
   * The sum of counts for priors.
   */
  protected float m_ClassPriorsSum;
   ...
   * Sum of errors.
   */
  protected float m_SumErr;

  /**
   * Sum of absolute errors.
   */
  protected float m_SumAbsErr;

  /**
   * Sum of squared errors.
   */
  protected float m_SumSqrErr;

  /**
   * Sum of class values.
   */
  protected float m_SumClass;

  /**
   * Sum of squared class values.
   */
  protected float m_SumSqrClass;

  /*** Sum of predicted values. */
  protected float m_SumPredicted;

  /**
   * Sum of squared predicted values.
   */
  protected float m_SumSqrPredicted;

  /**
   * Sum of predicted * class values.
   */
  protected float m_SumClassPredicted;

  /**
   * Sum of absolute errors of the prior.
   */
  protected float m_SumPriorAbsErr;

  /**
   * Sum of absolute errors of the prior.
   */
  protected float m_SumPriorSqrErr;

  /**
   * Total Kononenko & Bratko Information.
   */
  protected float m_SumKBInfo;
   ...
   */
  protected float m_MarginCounts[];
   ...
   */
  protected float[] m_TrainClassVals;

  /**
   * Array containing all numeric training class weights.
   */
  protected float[] m_TrainClassWeights;
   ...
   * in Sf calculations.
   */
  protected static final float MIN_SF_PROB = Float.MIN_VALUE;

  /**
   * Total entropy of prior predictions.
   */
  protected float m_SumPriorEntropy;

  /**
   * Total entropy of scheme predictions.
   */
  protected float m_SumSchemeEntropy;
   ...
   */
  protected float m_ConfLevel = 0.95f;

  /**
   * Total size of predicted regions at the given confidence level.
   */
  protected float m_TotalSizeOfRegions;

  /**
   * Total coverage of test cases at the given confidence level.
   */
  protected float m_TotalCoverage;

  /**
   * Minimum target value.
   */
  protected float m_MinTarget;

  /**
   * Maximum target value.
   */
  protected float m_MaxTarget;
  ...
  public Evaluation(Instances data, CostMatrix costMatrix) throws Exception {
    ...
    if (m_ClassIsNominal) {
      m_ConfusionMatrix = new float[m_NumClasses][m_NumClasses];
    ...
    m_ClassPriors = new float[m_NumClasses];
    setPriors(data);
    m_MarginCounts = new float[k_MarginResolution + 1];
   ...
   */
  public float areaUnderROC(int classIndex) {
   ...
   */
  public float weightedAreaUnderROC() {
	  float[] classCounts = new float[m_NumClasses];
	  float classCountSum = 0;
   ...
   */
  public float areaUnderPRC(int classIndex) {
    // Check if any predictions have been collected
    if (m_Predictions == null) {
      return Utils.missingValue();
    } else {
   ...
   */
  public float weightedAreaUnderPRC() {
	  float[] classCounts = new float[m_NumClasses];
	  float classCountSum = 0;
  ...
  public float[][] confusionMatrix() {
	  ...
	  float[][] newMatrix = new float[m_ConfusionMatrix.length][0];

    for (int i = 0; i < m_ConfusionMatrix.length; i++) {
      newMatrix[i] = new float[m_ConfusionMatrix[i].length];
  ...
  public void crossValidateModel(Classifier classifier, Instances data,
    ...
    for (int i = 0; i < numFolds; i++) {
      ...
      if (classificationOutput == null && forPrinting.length > 0) {
        ((StringBuffer)forPrinting[0]).append("\n=== Classifier model (training fold ")
        .append(i + 1).append(") ===\n\n").append(copiedClassifier);
      }
  ...
  public static String evaluateModel(Classifier classifier, String[] options) throws Exception {
    ...
    try {
      ...
      if (splitPercentageString.length() != 0) {
        ...
        splitPercentage = Float.parseFloat(splitPercentageString);
        ...
        if (classifier instanceof OptionHandler) {
          for (String option : options) {
            if (option.length() != 0) {
              ...
              if (option.indexOf(' ') != -1) {
                schemeOptionsText.append('"').append(option).append("\" ");
              } else {
                schemeOptionsText.append(option).append(" ");
              }
            }
          }
    ...
    if (!(noOutput || printMargins || classificationOutput != null)) {
      if (classifier instanceof OptionHandler) {
        if (schemeOptionsText != null) {
          text.append("\nOptions: ").append(schemeOptionsText).append("\n");
        }
      }
      text.append("\n=== Classifier model (full training set) ===\n\n").append(classifier.toString()).append("\n");
      text.append("\nTime taken to build model: ").append(Utils.doubleToString(trainTimeElapsed / 1000.0f, 2)).append(" seconds\n");
    }
    ...
    if (classificationOutput != null) {
      ...
      if (testFileName.length() > 0) {
        ...
        if (train != null && trainStatistics && !printMargins) {
          ...
          text.append(Utils.doubleToString(testTimeElapsed / 1000.0f, 2)).append(" seconds");
          text.append(trainingEvaluation.toSummaryString("\n\n=== Error on training data ===\n", printComplexityStatistics));
          if (template.classAttribute().isNominal()) {
            if (classStatistics) {
              text.append("\n\n").append(trainingEvaluation.toClassDetailsString());
            }
            text.append("\n\n").append(trainingEvaluation.toMatrixString());
          }
        }
        ...
        if (template.classAttribute().isNominal()) {
          if (classStatistics) {
            text.append("\n\n").append(testingEvaluation.toClassDetailsString());
          }
          text.append("\n\n").append(testingEvaluation.toMatrixString());
        }
      } else if (splitPercentage > 0) { // CASE 2: PERCENTAGE SPLIT
        ...
        if (template.classAttribute().isNumeric()) {
          text.append("\n\n\n").append(testingEvaluation.toSummaryString("=== Cross-validation ===\n",
                  printComplexityStatistics));
        } else {
          text.append("\n\n\n").append( testingEvaluation.toSummaryString("=== Stratified cross-validation ===\n", printComplexityStatistics));
        }
        if (template.classAttribute().isNominal()) {
          if (classStatistics) {
            text.append("\n\n").append(testingEvaluation.toClassDetailsString());
   ...
   * @throws Exception if model could not be evaluated successfully
   */
  public float[] evaluateModel(Classifier classifier, Instances data,
    Object... forPredictionsPrinting) throws Exception {
    // for predictions printing
    AbstractOutput classificationOutput = null;

    float predictions[] = new float[data.numInstances()];
   ...
   * @throws Exception if model could not be evaluated successfully
   */
  public float evaluationForSingleInstance(float[] dist, Instance instance,
   ...
   */
  protected float evaluationForSingleInstance(Classifier classifier,
      ...
      if (!instance.classIsMissing() && !Utils.isMissingValue(pred)) {
        if (classifier instanceof IntervalEstimator) {
          updateStatsForIntervalEstimator((IntervalEstimator) classifier,
            classMissing, (float) instance.classValue());
        } else {
   ...
   *           contains string attributes
   */
  public float evaluateModelOnceAndRecordPrediction(Classifier classifier,
   ...
   * @throws Exception if model could not be evaluated successfully
   */
  public float evaluateModelOnce(float[] dist, Instance instance)
    throws Exception {
   ...
   * @throws Exception if model could not be evaluated successfully
   */
  public float evaluateModelOnceAndRecordPrediction(float[] dist,
    Instance instance) throws Exception {
   ...
   * @throws Exception if model could not be evaluated successfully
   */
  public void evaluateModelOnce(float prediction, Instance instance)
    throws Exception {
  ...
  public static String
    ...
    result.append("// Generated with Weka ").append(Version.VERSION ).append("\n");
    result.append("//\n");
    result
    ...
    result.append("    \n");
    result.append("    return ").append(className).append(".classify(s);\n");
    result.append("  }\n");
    ...
    append(classifier.getClass().getName()).append(" (generated with Weka ").
   ...
   */
  public final float numInstances() {
   ...
   */
  public final float coverageOfTestCasesByPredictedRegions() {
   ...
   */
  public final float sizeOfPredictedRegions() {
   ...
   */
  public final float missingClass() {
   ...
   */
  public final float pctIncorrect() {
   ...
   */
  public final float unclassified() {
   ...
   */
  public final float pctUnclassified() {
  ...
  public final float errorRate() {
    ...
    if (!m_ClassIsNominal) {
      return (float) Math.sqrt(m_SumSqrErr / (m_WithClass - m_Unclassified));
    }
    if (m_CostMatrix == null) {
  ...
  public final float kappa() {
    ...
    float[] sumRows = new float[m_ConfusionMatrix.length];
    float[] sumColumns = new float[m_ConfusionMatrix.length];
   ...
   */
  public final float correlationCoefficient() throws Exception {
    ...
    if (varActual * varPredicted <= 0) {
      ...
      correlation = (float) (varProd / Math.sqrt(varActual * varPredicted));
    }
   ...
   */
  public final float meanAbsoluteError() {
   ...
   * @return the mean absolute error
   */
  public final float meanPriorAbsoluteError() {
   ...
   */
  public final float relativeAbsoluteError() throws Exception {
   ...
   */
  public final float rootMeanSquaredError() {
   ...
   */
  public final float rootMeanPriorSquaredError() {

    if (m_NoPriors) {
      return Float.NaN;
    }

    return (float) Math.sqrt(m_SumPriorSqrErr / m_WithClass);
  }
   ...
   */
  public final float rootRelativeSquaredError() {

    if (m_NoPriors) {
      return Float.NaN;
    }

    return (float) (100.0 * rootMeanSquaredError() / rootMeanPriorSquaredError());
  }
   ...
   */
  public final float priorEntropy() {
   ...
   */
  public final float KBInformation() throws Exception {
   ...
   * @throws Exception if the class is not nominal
   */
  public final float KBMeanInformation() throws Exception {
   ...
   * @throws Exception if the class is not nominal
   */
  public final float KBRelativeInformation() throws Exception {
    ...
    return (float) (100.0 * KBMeanInformation() / priorEntropy());
  }
   ...
   */
  public final float SFPriorEntropy() {
   ...
   * @return the null model entropy per instance
   */
  public final float SFMeanPriorEntropy() {
   ...
   */
  public final float SFSchemeEntropy() {
   ...
   */
  public final float SFMeanSchemeEntropy() {
   ...
   */
  public final float SFEntropyGain() {
   ...
   */
  public final float SFMeanEntropyGain() {
  ...
  public String toCumulativeMarginDistributionString() throws Exception {
    ...
    for (int i = 0; i <= k_MarginResolution; i++) {
      if (m_MarginCounts[i] != 0) {
        ...
        margin = (float) (i * 2.0 / k_MarginResolution - 1.0);
        result =
  ...
  public String
    ...
    try {
      if (m_WithClass > 0) {
        if (m_ClassIsNominal) {
          ...
          if (displayCorrect) {
            ...
            text.append(Utils.doubleToString(correct(), 12, 4)).append("     ")
            .append(Utils.doubleToString(pctCorrect(), 12, 4)).append(" %\n");
          }
          if (displayIncorrect) {
            text.append("Incorrectly Classified Instances   ");
            text.append(Utils.doubleToString(incorrect(), 12, 4)).append("     ")
            .append(Utils.doubleToString(pctIncorrect(), 12, 4)).append(" %\n");
          }
          if (displayKappa) {
            text.append("Kappa statistic                    ");
            text.append(Utils.doubleToString(kappa(), 12, 4)).append("\n");
          }

          if (m_CostMatrix != null) {
            if (displayTotalCost) {
              text.append("Total Cost                         ");
              text.append(Utils.doubleToString(totalCost(), 12, 4)).append("\n");
            }
            if (displayAverageCost) {
              text.append("Average Cost                       ");
              text.append(Utils.doubleToString(avgCost(), 12, 4)).append("\n");
            }
          }
          if (printComplexityStatistics) {
            ...
            if (displayKBRelative) {
              ...
              text.append(Utils.doubleToString(KBRelativeInformation(), 12, 4)).append(" %\n");
            }
            if (displayKBInfo) {
              text.append("K&B Information Score              ");
              text.append(Utils.doubleToString(KBInformation(), 12, 4)).append(" bits");
              text.append(Utils.doubleToString(KBMeanInformation(), 12, 4)).append(" bits/instance\n");
            }
          }
        ...
        if (printComplexityStatistics && m_ComplexityStatisticsAvailable) {
          ...
          if (displayComplexityOrder0) {
            ...
            text
              .append(Utils.doubleToString(SFPriorEntropy(), 12, 4)).append(" bits");
            text.append(Utils.doubleToString(SFMeanPriorEntropy(), 12, 4)).append(" bits/instance\n");
          }
          if (displayComplexityScheme) {
            text.append("Class complexity | scheme          ");
            text.append(Utils.doubleToString(SFSchemeEntropy(), 12, 4)).append(" bits");
            text.append(Utils.doubleToString(SFMeanSchemeEntropy(), 12, 4)).append(" bits/instance\n");
          }
          if (displayComplexityImprovement) {
            text.append("Complexity improvement     (Sf)    ");
            text.append(Utils.doubleToString(SFEntropyGain(), 12, 4)).append(" bits");
            text.append(Utils.doubleToString(SFMeanEntropyGain(), 12, 4)).append(" bits/instance\n");
          }
        }
        ...
        if (displayMAE) {
          ...
          text.append(Utils.doubleToString(meanAbsoluteError(), 12, 4)).append("\n");
        }
        if (displayRMSE) {
          text.append("Root mean squared error            ");
          text.append(Utils.doubleToString(rootMeanSquaredError(), 12, 4)).append("\n");
        }
        if (!m_NoPriors) {
          if (displayRAE) {
            text.append("Relative absolute error            ");
            text.append(Utils.doubleToString(relativeAbsoluteError(), 12, 4)).append(" %\n");
          }
          if (displayRRSE) {
            text.append("Root relative squared error        ");
            text.append(Utils.doubleToString(rootRelativeSquaredError(), 12, 4)).append(" %\n");
          }
        }
        if (m_pluginMetrics != null) {
          for (AbstractEvaluationMetric m : m_pluginMetrics) {
        ...
        if (m_CoverageStatisticsAvailable) {
          ...
          if (displayCoverage) {
            text.append("Coverage of cases (").append(Utils.doubleToString(m_ConfLevel, 4, 2)).
            append(" level)     ");
            text.append(Utils.doubleToString(
              coverageOfTestCasesByPredictedRegions(), 12, 4)).append(" %\n");
          }
          if (!m_NoPriors) {
            if (displayRegionSize) {
              text.append("Mean rel. region size (")
              .append(Utils.doubleToString(m_ConfLevel, 4, 2)).append(" level) ");
              text.append(Utils.doubleToString(sizeOfPredictedRegions(), 12, 4)).append(" %\n");
            }
          }
        }
      }
      if (Utils.gr(unclassified(), 0)) {
        ...
        text.append(Utils.doubleToString(unclassified(), 12, 4)).append("     ")
        .append(Utils.doubleToString(pctUnclassified(), 12, 4)).append(" %\n");
      }
      text.append("Total Number of Instances          ");
      text.append(Utils.doubleToString(m_WithClass, 12, 4)).append("\n");
      if (m_MissingClass > 0) {
        text.append("Ignored Class Unknown Instances            ");
        text.append(Utils.doubleToString(m_MissingClass, 12, 4)).append("\n");
      }
    } catch (Exception ex) {
  ...
  public String toMatrixString(String title) throws Exception {
    ...
    for (int i = 0; i < m_NumClasses; i++) {
      for (int j = 0; j < m_NumClasses; j++) {
        float current = m_ConfusionMatrix[i][j];
        if (current < 0) {
          current *= -10;
        }
        if (current > maxval) {
        ...
        float fract = (float) (current - Math.rint(current));
  ...
  public String toClassDetailsString(String title) throws Exception {
    ...
    for (int i = 0; i < m_NumClasses; i++) {
      ...
      if (displayMCC) {
        float mat = matthewsCorrelationCoefficient(i);
    ...
    if (displayTP) {
      float wtpr = weightedTruePositiveRate();
    ...
    if (displayFP) {
      float wfpr = weightedFalsePositiveRate();
    ...
    if (displayMCC) {
      float wmc = weightedMatthewsCorrelation();
    ...
    if (displayROC) {
      float wroc = weightedAreaUnderROC();
    ...
    if (displayPRC) {
      float wprc = weightedAreaUnderPRC();
   ...
   */
  public float numTruePositives(int classIndex) {
   ...
   * @return the true positive rate
   */
  public float truePositiveRate(int classIndex) {
   ...
   */
  public float weightedTruePositiveRate() {
    float[] classCounts = new float[m_NumClasses];
    float classCountSum = 0;
    ...
    float truePosTotal = 0;
    for (int i = 0; i < m_NumClasses; i++) {
      float temp = truePositiveRate(i);
      if (classCounts[i] > 0) { // If temp is NaN, we want the sum to also be NaN if count > 0
   ...
   * @return the true positive rate
   */
  public float numTrueNegatives(int classIndex) {
   ...
   * @return the true positive rate
   */
  public float trueNegativeRate(int classIndex) {
   ...
   */
  public float weightedTrueNegativeRate() {
    float[] classCounts = new float[m_NumClasses];
    float classCountSum = 0;
    ...
    float trueNegTotal = 0;
    for (int i = 0; i < m_NumClasses; i++) {
      float temp = trueNegativeRate(i);
      if (classCounts[i] > 0) { // If temp is NaN, we want the sum to also be NaN if count > 0
   ...
   */
  public float numFalsePositives(int classIndex) {
   ...
   * @return the false positive rate
   */
  public float falsePositiveRate(int classIndex) {
   ...
   */
  public float weightedFalsePositiveRate() {
    float[] classCounts = new float[m_NumClasses];
    float classCountSum = 0;
    ...
    float falsePosTotal = 0;
    for (int i = 0; i < m_NumClasses; i++) {
      float temp = falsePositiveRate(i);
      if (classCounts[i] > 0) { // If temp is NaN, we want the sum to also be NaN if count > 0
   ...
   * @return the false positive rate
   */
  public float numFalseNegatives(int classIndex) {
   ...
   * @return the false positive rate
   */
  public float falseNegativeRate(int classIndex) {
   ...
   */
  public float weightedFalseNegativeRate() {
    float[] classCounts = new float[m_NumClasses];
    float classCountSum = 0;
    ...
    float falseNegTotal = 0;
    for (int i = 0; i < m_NumClasses; i++) {
      float temp = falseNegativeRate(i);
      if (classCounts[i] > 0) { // If temp is NaN, we want the sum to also be NaN if count > 0
   ...
   */
  public float matthewsCorrelationCoefficient(int classIndex) {
    float numTP = numTruePositives(classIndex);
    float numTN = numTrueNegatives(classIndex);
    float numFP = numFalsePositives(classIndex);
    float numFN = numFalseNegatives(classIndex);
    float n = (numTP * numTN) - (numFP * numFN);
    float d =
   ...
   */
  public float weightedMatthewsCorrelation() {
    float[] classCounts = new float[m_NumClasses];
    float classCountSum = 0;
    ...
    float mccTotal = 0;
    for (int i = 0; i < m_NumClasses; i++) {
      float temp = matthewsCorrelationCoefficient(i);
      if (classCounts[i] > 0) { // If temp is NaN, we want the sum to also be NaN if count > 0
   ...
   * @return the recall
   */
  public float recall(int classIndex) {
   ...
   */
  public float precision(int classIndex) {
   ...
   */
  public float fMeasure(int classIndex) {

    float precision = precision(classIndex);
    float recall = recall(classIndex);
   ...
   * */
  public float unweightedMacroFmeasure() {
   ...
   */
  public float unweightedMicroFmeasure() {
    float tp = 0;
    float fn = 0;
    float fp = 0;
    for (int c = 0; c < m_NumClasses; c++) {
  ...
  public void setPriors(Instances train) throws Exception {
    ...
    if (!m_ClassIsNominal) {
      ...
      m_MinTarget = Float.MAX_VALUE;
      m_MaxTarget = -Float.MAX_VALUE;
  ...
  protected static String makeOptionString(Classifier classifier,
    ...
    optionsText
      ...
      .append("All metrics are output by default with the exception of 'Coverage' and ").
      append("'Region size'.\n\t");
    ...
    optionsText.append("\tE.g.: ").append(PlainText.class.getName()).append("\n");
    ...
    optionsText
      ...
      .append("\tThe format is determined by the extensions, e.g., '.arff' for ARFF \n\tformat or '.csv' for CSV.\n");
  ...
  protected static String getGlobalInfo(Classifier classifier) throws Exception {
    ...
    Object[] args = {};
    String result =
    		new StringBuilder("\nSynopsis for ").append(classifier.getClass().getName()).append(":\n\n").toString();
   ...
   */
  protected float[] makeDistribution(float predictedClass) {

    float[] result = new float[m_NumClasses];
   ...
   * @throws Exception if the class of the instance is not set
   */
  protected void updateStatsForClassifier(float[] predictedDistribution,
    Instance instance) throws Exception {
    ...
    if (!instance.classIsMissing()) {
      ...
      if (predictedProb >= priorProb) {
        ...
        m_SumKBInfo -=
          (Utils.log2(1.0f - predictedProb) - Utils.log2(1.0f - priorProb))
            * instance.weight();
      }
  ...
  protected void updateStatsForIntervalEstimator(IntervalEstimator classifier,
    Instance classMissing, float classValue) throws Exception {

    float[][] preds = classifier.predictIntervals(classMissing, m_ConfLevel);
    if (m_Predictions != null) {
  ...
  protected void updateStatsForConditionalDensityEstimator(
    ...
    float classValue) throws Exception {
   ...
   * @throws Exception if the class of the instance is not set
   */
  protected void updateStatsForPredictor(float predictedValue,
    Instance instance) throws Exception {
   ...
   */
  protected void updateMargins(float[] predictedDistribution, int actualClass,
    float weight) {

    float probActual = predictedDistribution[actualClass];
    float probNext = 0;
    ...
    float margin = probActual - probNext;
   ...
   */
  protected void updateNumericScores(float[] predicted, float[] actual,
    float weight) {

    float diff;
    float sumErr = 0, sumAbsErr = 0, sumSqrErr = 0;
    float sumPriorAbsErr = 0, sumPriorSqrErr = 0;
    for (int i = 0; i < m_NumClasses; i++) {
   ...
   * 
   * @param d the class value
   * @param weight the instance weight
   */
  protected void addNumericTrainClass(float d, float weight) {
  ...
  public String getRevision() {
    return RevisionUtils.extract("$Revision: 14755 $");
  }
}
