...
public class TwoClassStats implements RevisionHandler {
  ...
  private float m_TruePos;

  /** Neg predicted as pos */
  private float m_FalsePos;

  /** Neg predicted as neg */
  private float m_TrueNeg;

  /** Pos predicted as neg */
  private float m_FalseNeg;
   ...
   */
  public TwoClassStats(float tp, float fp, float tn, float fn) {
