...
public interface InformationRetrievalEvaluationMetric {
   ...
   */
  void updateStatsForClassifier(float[] predictedDistribution,
   ...
   *         reason
   */
  float getStatistic(String statName, int classIndex);
   ...
   *         appropriate).
   */
  float getClassWeightedAverageStatistic(String statName);
}
