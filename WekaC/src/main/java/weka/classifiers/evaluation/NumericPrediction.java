...
public class NumericPrediction
  ...
  private float[][] m_PredictionIntervals;
   ...
   */
  public NumericPrediction(float actual, float predicted) {
   ...
   */
  public NumericPrediction(float actual, float predicted, float weight) {
    this(actual, predicted, weight, new float[0][]);
  }
   ...
   */
  public NumericPrediction(float actual, float predicted, float weight, float[][] predInt) {
    m_Actual = actual;
   ...
   * 
   * @param preds the prediction intervals
   */
  public void setPredictionIntervals(float[][] preds) {
    m_PredictionIntervals = preds.clone();
    System.arraycopy(preds, 0, m_PredictionIntervals,  
            0, preds.length);
  }
