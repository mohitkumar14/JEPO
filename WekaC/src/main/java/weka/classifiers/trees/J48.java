...
public class J48 extends AbstractClassifier implements OptionHandler, Drawable,
  ...
  public String[] getOptions() {
    ...
    if (m_unpruned) {
      ...
      if (m_reducedErrorPruning) {
          options.add("-R");
          options.add("-N");
          options.add(String.valueOf(m_numFolds));
          options.add("-Q");
          options.add(String.valueOf(m_Seed));
      } else {
          options.add("-C");
          options.add(String.valueOf( m_CF));
      }
    }
    if (m_binarySplits) {
        options.add("-B");
    ...
    options.add("-M");
    options.add(String.valueOf(m_minNumObj));
    if (m_useLaplace) {
        options.add("-A");
    }
  ...
  public String toSummaryString() {
    ...
    return new StringBuilder("Number of leaves: ").append(m_root.numLeaves())
    		.append("\nSize of the tree: ").append(m_root.numNodes()).append("\n").toString();
  }
