...
public abstract class ClassifierSplitModel
   ...
   * @exception Exception if something goes wrong
   */
  public final float classifyInstance(Instance instance)
       throws Exception {
    ...
    if (theSubset > -1)
      return (float)m_distribution.maxClass(theSubset);
    else
      return (float)m_distribution.maxClass();
  }
   ...
   * @exception Exception if something goes wrong
   */
  public float classProb(int classIndex, Instance instance, int theSubset) 
       throws Exception {
   ...
   * @exception Exception if something goes wrong
   */
  public float classProbLaplace(int classIndex, Instance instance,
   ...
   */
  public abstract float[] weights(Instance instance);
