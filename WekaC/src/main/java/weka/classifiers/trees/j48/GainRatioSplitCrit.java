...
public final class GainRatioSplitCrit extends EntropyBasedSplitCrit {
   ...
   */
  @Override
  public final float splitCritValue(Distribution bags) {
   ...
   */
  public final float splitCritValue(Distribution bags, float totalnoInst,
    float numerator) {
   ...
   */
  private final float splitEnt(Distribution bags, float totalnoInst) {
