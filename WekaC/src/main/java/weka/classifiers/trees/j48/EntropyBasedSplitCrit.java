...
public abstract class EntropyBasedSplitCrit
   ...
   */
  public final float lnFunc(float num) {
   ...
   */
  public final float oldEnt(Distribution bags) {
   ...
   */
  public final float newEnt(Distribution bags) {
   ...
   * class values.
   */
  public final float splitEnt(Distribution bags) {
