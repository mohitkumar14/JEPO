...
public class C45PruneableClassifierTree 
  ...
  public void prune() throws Exception {
	...
	errorsLargestBranch = Float.MAX_VALUE;
      }
	...
	getEstimatedErrorsForDistribution(localModel().distribution());
      ...
      if (Utils.smOrEq(errorsLeaf,errorsTree+0.1f) &&
	  Utils.smOrEq(errorsLeaf,errorsLargestBranch+0.1f)){
	...
	return;
      ...
      // than whole subtree.
      if (Utils.smOrEq(errorsLargestBranch,errorsTree+0.1f)){
   ...
   */
  private float getEstimatedErrors(){
   ...
   * @throws Exception if something goes wrong
   */
  private float getEstimatedErrorsForBranch(Instances data) 
       throws Exception {
   ...
   * @return the estimated errors
   */
  private float getEstimatedErrorsForDistribution(Distribution 
						   theDistribution){
   ...
   */
  private float getTrainingErrors(){
