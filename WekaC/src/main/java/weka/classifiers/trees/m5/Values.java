...
public final class Values
  ...
  int  attr;                // attribute
  float  sum;              // sum of the instances for attribute
  float  sqrSum;           // squared sum of the instances for attribute
  float  va;               // variance
  ...
  public final String  toString(){
    ...
    text.append("Print statistic values of instances (").append(first).append("-").append(last).append("\n");
    text.append("    Number of instances:\t").append(numInstances).append("\n");
    text.append("    NUmber of instances with unknowns:\t").append(missingInstances).append("\n");
    text.append("    Attribute:\t\t\t:").append(attr).append("\n");
    text.append("    Sum:\t\t\t").append(sum).append("\n");
    text.append("    Squared sum:\t\t").append(sqrSum).append("\n");
    text.append("    Stanard Deviation:\t\t").append(sd).append("\n");
