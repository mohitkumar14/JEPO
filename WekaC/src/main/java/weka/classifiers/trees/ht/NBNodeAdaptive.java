...
public class NBNodeAdaptive extends NBNode implements LearningNode,
  ...
  protected float m_majClassCorrectWeight = 0;

  /** The number of correct predictions made by naive Bayes */
  protected float m_nbCorrectWeight = 0;
   ...
   */
  public NBNodeAdaptive(Instances header, float nbWeightThreshold)
      throws Exception {
  ...
  protected int dumpTree(int depth, int leafCount, StringBuffer buff) {
    ...
    buff.append(" NB adaptive").append(m_leafNum);
  ...
  protected void printLeafModels(StringBuffer buff) {
    buff.append("NB adaptive").append(m_leafNum).append("\n")
