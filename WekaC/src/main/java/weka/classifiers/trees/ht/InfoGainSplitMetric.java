...
public class InfoGainSplitMetric extends SplitMetric implements Serializable {
  ...
  protected float m_minFracWeightForTwoBranches;

  public InfoGainSplitMetric(float minFracWeightForTwoBranches) {
