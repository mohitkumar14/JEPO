...
public abstract class SplitMetric implements Serializable {
   ...
   */
  public static float sum(Map<String, WeightMass> dist) {
    float sum = 0;
   ...
   */
  public abstract float evaluateSplit(Map<String, WeightMass> preDist,
   ...
   */
  public abstract float getMetricRange(Map<String, WeightMass> preDist);
}
