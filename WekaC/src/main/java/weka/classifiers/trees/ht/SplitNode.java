    ...
    for (Map.Entry<String, HNode> e : m_children.entrySet()) {
      ...
      if (child != null) {
        ...
        if (first) {
          ...
          first = false;
          buff.append("N").append(m_nodeNum).append(" [label=\"").append(testAttName).append("\"]\n");
        }
        ...
        buff.append(
          "N").append(m_nodeNum).append("->N").append(child.m_nodeNum).append("[label=\""
        		  ).append(conditionForBranch).append("\"]\n").append("\n");
