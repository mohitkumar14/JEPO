...
public class NBNode extends ActiveHNode implements LearningNode, Serializable {
   ...
   */
  protected float m_nbWeightThreshold;
   ...
   */
  public NBNode(Instances header, float nbWeightThreshold) throws Exception {
  ...
  protected float[] bypassNB(Instance inst, Attribute classAtt)
      throws Exception {
  ...
  protected int dumpTree(int depth, int leafCount, StringBuffer buff) {
    ...
    buff.append(" NB").append(m_leafNum);
  ...
  protected void printLeafModels(StringBuffer buff) {
    buff.append("NB").append(m_leafNum).append("\n").append(m_bayes.toString());
  }
}
