...
public class LMT extends AbstractClassifier implements OptionHandler,
   ...
   **/
  protected float m_weightTrimBeta;
  ...
  public float classifyInstance(Instance instance) throws Exception {
    ...
    float[] probs = distributionForInstance(instance);
  ...
  public Enumeration<Option> listOptions() {
    ...
    newVector.addElement(new Option(
      "\tUse error on probabilities instead of misclassification error for stopping criterion of LogitBoost.", "P", 0, "-P"));

    newVector.addElement(new Option(
      "\tSet fixed number of iterations for LogitBoost (instead of using cross-validation)", "I", 1, "-I <numIterations>"));
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (optionString.length() != 0) {
      setWeightTrimBeta((new Float(optionString)).floatValue());
    }
  ...
  public String[] getOptions() {
    ...
    options.add("-I");
    options.add(String.valueOf(getNumBoostingIterations()));

    options.add("-M");
    options.add(String.valueOf(getMinNumInstances()));

    options.add("-W");
    options.add(String.valueOf(getWeightTrimBeta()));
   ...
   */
  public void setWeightTrimBeta(float n) {
    m_weightTrimBeta = n;
  }
