...
public class RandomSubSpace
  ...
  protected float m_SubSpaceSize = 0.5f;
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (tmpStr.length() != 0)
      setSubSpaceSize(Float.parseFloat(tmpStr));
    else
      setSubSpaceSize(0.5f);
  ...
  public String [] getOptions() {
    ...
    result.add("-P");
    result.add(String.valueOf(getSubSpaceSize()));
   ...
   */
  public void setSubSpaceSize(float value) {
   ...
   */
  protected int numberOfAttributes(int total, float fraction) {
