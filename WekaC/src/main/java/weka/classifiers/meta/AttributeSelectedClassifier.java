...
public class AttributeSelectedClassifier 
  ...
  protected float m_numAttributesSelected;

  /** The time taken to select attributes in milliseconds */
  protected float m_selectionTime;
  ...
  public Enumeration<Option> listOptions() {
    ...
    if (getEvaluator() instanceof OptionHandler) {
      newVector.addElement(new Option(
        ...
        .append(getEvaluator().getClass().getName()).append(":").toString()));
    ...
    if (getSearch() instanceof OptionHandler) {
      newVector.addElement(new Option(
        ...
        "", 0, new StringBuilder("\nOptions specific to search method ")
    		  .append(getSearch().getClass().getName()).append(":").toString()));
  ...
  public String [] getOptions() {
    ...
    options.add("-E");
    options.add(String.valueOf(getEvaluatorSpec()));
  ...
  protected String getEvaluatorSpec() {
    ...
    if (e instanceof OptionHandler) {
      return new StringBuilder(e.getClass().getName())
    		  .append(" ").append(Utils.joinOptions(((OptionHandler)e).getOptions())).toString();
    }
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    float weight = newData.instance(0).weight();
    boolean ok = false;
    ...
    m_ReducedHeader = 
      new Instances((m_Classifier instanceof WeightedInstancesHandler) ?
                    newData
                    : resampledData, 0);
    m_selectionTime = (float)(end - start);
    m_totalTime = (float)(end2 - start);
  }
  ...
  public String toString() {
    ...
    result.append("\n\nHeader of reduced data:\n").append(m_ReducedHeader.toString());
    result.append("\n\nClassifier Model\n"+m_Classifier.toString());
   ...
   */
  public float measureNumAttributesSelected() {
   ...
   */
  public float measureSelectionTime() {
