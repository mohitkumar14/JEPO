...
public class FilteredClassifier extends RandomizableSingleClassifierEnhancer
   ...
   */
  public float[] getMembershipValues(Instance inst) throws Exception {
    ...
    if (m_Classifier instanceof PartitionGenerator) {
      ...
      if (newInstance == null) {
        float[] unclassified = new float[numElements()];
  ...
  public void initializeClassifier(Instances data) throws Exception {
    ...
    if (m_Classifier instanceof IterativeClassifier) {
    	...
    	if(data.numInstances() > 0)
    		r = data.getRandomNumberGenerator(getSeed());
    	else
  ...
  public Enumeration<Option> listOptions() {
    ...
    newVector.addElement(new Option(
    		new StringBuilder("\tFull class name of filter to use, followed\n\tby filter options.\n\tdefault: \"").append(defaultFilterString()).append("\"").toString(),
    ...
    if (getFilter() instanceof OptionHandler) {
      newVector.addElement(new Option("", "", 0, new StringBuilder("\nOptions specific to filter ").append(getFilter().getClass().getName()).append(":").toString()));
      newVector
  ...
  public String[] getOptions() {
    ...
    options.add("-F");
    options.add(String.valueOf(getFilterSpec()));
  ...
  protected String getFilterSpec() {
    ...
    if (c instanceof OptionHandler) {
      return new StringBuilder(c.getClass().getName()).append(" ")
    		  .append(Utils.joinOptions(((OptionHandler) c).getOptions())).toString();
    }
  ...
  protected Instances resampleAttributes(Instances data, boolean original, Random random) throws Exception {
    ...
    int index = 0;
    float[] attributeWeights = new float[nAtt];
  ...
  public float[] distributionForInstance(Instance instance) throws Exception {
    ...
    if (newInstance == null) {
      ...
      // instance
      float[] unclassified = null;
      if (instance.classAttribute().isNumeric()) {
        unclassified = new float[1];
        unclassified[0] = Utils.missingValue();
      } else {
        // all zeros
        unclassified = new float[instance.classAttribute().numValues()];
      }
      return unclassified;
    } else {
      if (m_ReorderFiltered != null) {
   ...
   */
  public float[][] distributionsForInstances(Instances insts)
    throws Exception {
    ...
    if (getClassifier() instanceof BatchPredictor) {
      ...
      float[][] result = new float[insts.numInstances()][insts.numClasses()];
  ...
  public String toString() {
    ...
    String result = new StringBuilder("FilteredClassifier using ").append(getClassifierSpec())
    		.append(" on data filtered through ").append(getFilterSpec()).append("\n\nFiltered Header\n")
    		.append(m_FilteredInstances.toString()).append("\n\nClassifier Model\n")
    		.append(m_Classifier.toString()).toString();
    return result;
  }
