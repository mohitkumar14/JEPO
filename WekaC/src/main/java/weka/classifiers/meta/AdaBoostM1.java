...
public class AdaBoostM1 extends RandomizableIteratedSingleClassifierEnhancer
  ...
  public String[] getOptions() {
    ...
    result.add("-P");
    result.add(String.valueOf(getWeightThreshold()));
  ...
  public void initializeClassifier(Instances data) throws Exception {
    ...
    m_Betas = new float[m_Classifiers.length];
    ...
    if ((m_UseResampling)
      ...
      float sumProbs = m_TrainingData.sumOfWeights();
  ...
  public boolean next() throws Exception {
    ...
    if ((m_UseResampling)
      ...
      float[] weights = new float[trainData.numInstances()];
    ...
    if (Utils.grOrEq(epsilon, 0.5f) || Utils.eq(epsilon, 0)) {
    ...
    float reweight = (1 - epsilon) / epsilon;
    m_Betas[m_NumIterationsPerformed] = (float) Math.log(reweight);
    if (m_Debug) {
   ...
   */
  protected void setWeights(Instances training, float reweight)
    throws Exception {

    float oldSumOfWeights, newSumOfWeights;
  ...
  public float[] distributionForInstance(Instance instance) throws Exception {
    ...
    float[] sums = new float[instance.numClasses()];
  ...
  public String toSource(String className) throws Exception {
    ...
    if (m_NumIterationsPerformed == 1) {
      ...
      for (int i = 0; i < m_NumIterationsPerformed; i++) {
        text.append("    sums[(int) ").append(className).append('_').append(i)
        .append(".classify(i)] += ").append(m_Betas[i]).append(";\n");
      }
      text.append("    double maxV = sums[0];\n").append("    int maxI = 0;\n"
    		  ).append("    for (int j = 1; j < ").append(m_NumClasses).append("; j++) {\n"
