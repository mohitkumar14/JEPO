...
public class NaiveBayesUpdateable extends NaiveBayes 
  ...
  public String globalInfo() {
    return new StringBuilder("Class for a Naive Bayes classifier using estimator classes. This is the ")
      .append("updateable version of NaiveBayes.\n")
      .append("This classifier will use a default precision of 0.1 for numeric attributes ")
      .append("when buildClassifier is called with zero training instances.\n\n")
      .append("For more information on Naive Bayes classifiers, see\n\n")
