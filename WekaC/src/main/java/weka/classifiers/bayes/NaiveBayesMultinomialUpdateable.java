...
public class NaiveBayesMultinomialUpdateable extends NaiveBayesMultinomial implements UpdateableClassifier {
  ...
  public String globalInfo() {
    return 
    		new StringBuilder("Class for building and using an updateable multinomial Naive Bayes classifier. ")
  ...
  public void buildClassifier(Instances instances) throws Exception {
    ...
    m_wordsPerClass = new float[m_numClasses];
      ...
      for (int a = 0; a < instance.numValues(); a++) {
        if (instance.index(a) != instance.classIndex()) {
          if (!instance.isMissingSparse(a)) {
            float numOccurrences = instance.valueSparse(a) * instance.weight();
            if (numOccurrences < 0)
