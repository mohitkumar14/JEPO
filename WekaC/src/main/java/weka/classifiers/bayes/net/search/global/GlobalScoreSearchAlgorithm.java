...
public class GlobalScoreSearchAlgorithm extends SearchAlgorithm {
   ...
   *           updateClassifier
   */
  public float calcScore(BayesNet bayesNet) throws Exception {
    switch (m_nCVType) {
    case LOOCV:
  ...
  public float calcScoreWithExtraParent(int nNode, int nCandidateParent)
    ...
    // calculate the score
    float fAccuracy = calcScore(m_BayesNet);
   ...
   * @throws Exception if something goes wrong
   */
  public float calcScoreWithReversedParent(int nNode, int nCandidateParent)
    throws Exception {
    ParentSet oParentSet = m_BayesNet.getParentSet(nNode);
   ...
   */
  public float leaveOneOutCV(BayesNet bayesNet) throws Exception {
    m_BayesNet = bayesNet;
   ...
   * @throws Exception passed on by updateClassifier
   */
  public float cumulativeCV(BayesNet bayesNet) throws Exception {
    m_BayesNet = bayesNet;
    float fAccuracy = 0.0f;
    float fWeight = 0.0f;
    Instances instances = bayesNet.m_Instances;
   ...
   * @throws Exception passed on by updateClassifier
   */
  public float kFoldCV(BayesNet bayesNet, int nNrOfFolds) throws Exception {
    m_BayesNet = bayesNet;
    float fAccuracy = 0.0f;
    float fWeight = 0.0f;
    Instances instances = bayesNet.m_Instances;
   ...
   */
  float accuracyIncrease(Instance instance) throws Exception {
    if (m_bUseProb) {
      float[] fProb = m_BayesNet.distributionForInstance(instance);
