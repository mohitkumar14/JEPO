...
public class GUI extends JPanel implements LayoutCompleteEventListener {
  ...
  class MyAction extends AbstractAction {
    ...
    public MyAction(String sName, String sToolTipText, String sIcon,
      ...
      java.net.URL tempURL = ClassLoader.getSystemResource(new StringBuilder(ICONPATH).append(sIcon).append(".png").toString());
      if (tempURL != null) {
  ...
  class ActionGenerateNetwork extends MyAction {
    ...
    public void actionPerformed(ActionEvent ae) {
      if (dlg == null) {
        ...
        jTfNrOfNodes.setText(String.valueOf(m_nNrOfNodes));
        ...
        jTfNrOfArcs.setText(String.valueOf( m_nNrOfArcs));
        ...
        jTfCardinality.setText(String.valueOf(m_nCardinality));
        ...
        jTfSeed.setText(String.valueOf( m_nSeed));
        ...
        jBtGo.addActionListener(new ActionListener() {
          ...
          public void actionPerformed(ActionEvent ae) {
            try {
              ...
              options[0] = "-N";
              options[1] = String.valueOf(jTfNrOfNodes.getText());
              options[2] = "-A";
              options[3] = String.valueOf(jTfNrOfArcs.getText());
              options[4] = "-C";
              options[5] = String.valueOf(jTfCardinality.getText());
              options[6] = "-S";
              options[7] = String.valueOf(jTfSeed.getText());
  ...
  class ActionGenerateData extends MyAction {
    ...
    public void actionPerformed(ActionEvent ae) {
      if (dlg == null) {
        ...
        jTfNrOfInstances.setText(String.valueOf( m_nNrOfInstances));
        final JLabel jLbSeed = new JLabel("Random seed");
        final JTextField jTfSeed = new JTextField(3);
        jTfSeed.setHorizontalAlignment(JTextField.CENTER);
        jTfSeed.setText(String.valueOf(m_nSeed));
        ...
        jBtGo.addActionListener(new ActionListener() {
          ...
          public void actionPerformed(ActionEvent ae) {
            try {
              ...
              options[0] = "-M";
              options[1] = String.valueOf(jTfNrOfInstances.getText());
              options[2] = "-F";
  ...
  class ActionLearn extends MyAction {
    ...
    public void actionPerformed(ActionEvent ae) {
      if (dlg == null) {
            ...
            try {
              ...
              pd.addWindowListener(new WindowAdapter() {
                ...
                public void windowClosing(WindowEvent e) {
                  ...
                  System.out.println(new StringBuilder(c.getClass().getName()).append(" ").append(options));
                  System.exit(0);
                }
              });
              pd.setVisible(true);
        ...
        jTfOptions.setText(String.valueOf(Utils.joinOptions(m_BayesNet.getOptions())));
  ...
  class ActionZoomIn extends MyAction {
    ...
    public void actionPerformed(ActionEvent ae) {
      ...
      if (s >= 999) {
        ...
        m_fScale = (float) (m_nZoomPercents[i + 1] / 100D);
      } else {
        if (!a_zoomout.isEnabled()) {
          a_zoomout.setEnabled(true);
        }
        m_jTfZoom.setText(m_nZoomPercents[0] + "%");
        m_fScale = (float) (m_nZoomPercents[0] / 100D);
      }
      setAppropriateSize();
  ...
  class ActionZoomOut extends MyAction {
    ...
    public void actionPerformed(ActionEvent ae) {
      ...
      if (s <= 10) {
        ...
        m_fScale = (float) (m_nZoomPercents[22] / 100D);
      }
      setAppropriateSize();
      m_GraphPanel.repaint();
      m_GraphPanel.invalidate();
  ...
  private class GraphPanel extends PrintablePanel implements Printable {
    ...
    protected void drawNode(Graphics g, int iNode, int mode) {
      ...
      if (m_bViewMargins) {
        ...
        float[] P = m_BayesNet.getMargin(iNode);
      ...
      for (int iParent = 0; iParent < m_BayesNet.getNrOfParents(iNode); iParent++) {
        ...
        float phi = (float) Math.atan2((nPosX2b - nPosX1 + 0.0) * m_nNodeHeight,
    ...
    protected void drawArrow(Graphics g, int nPosX1, int nPosY1, int nPosX2,
      ...
      if (nPosX1 == nPosX2) {
        ...
        // line
        float hyp = 0, base = 0, perp = 0, theta, beta;
        int nPosX3 = 0, nPosY3 = 0;

        if (nPosX2 < nPosX1) {
          base = nPosX1 - nPosX2;
          hyp = (float) Math.sqrt((nPosX2 - nPosX1) * (nPosX2 - nPosX1)
            + (nPosY2 - nPosY1) * (nPosY2 - nPosY1));
          theta = (float) Math.acos(base / hyp);
        ...
        beta = (float) (30 * Math.PI / 180);

        hyp = 8;
        base = (float) (Math.cos(theta - beta) * hyp);
        perp = (float) (Math.sin(theta - beta) * hyp);
    ...
    public int print(Graphics g, PageFormat pageFormat, int pageIndex) {
      if (pageIndex > 0) {
        ...
        float fCurrentScale = m_fScale;
        xMax += m_nPaddedNodeWidth + 100;
        if (fWidth / xMax < fHeight / yMax) {
          m_fScale = (float) (fWidth / xMax);
        } else {
          m_fScale = (float) (fHeight / yMax);
        }
  ...
  private class GraphVisualizerTableModel extends AbstractTableModel {
    ...
    final float[][] m_fProbs;

    public GraphVisualizerTableModel(int iNode) {
      float[][] probs = m_BayesNet.getDistribution(iNode);
      m_fProbs = new float[probs.length][probs[0].length];
