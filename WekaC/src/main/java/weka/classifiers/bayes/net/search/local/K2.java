...
public class K2 extends LocalScoreSearchAlgorithm implements
  ...
  public void search(BayesNet bayesNet, Instances instances) throws Exception {
    ...
    for (int iOrder = 1; iOrder < instances.numAttributes(); iOrder++) {
      int iAttribute = nOrder[iOrder];
      float fBestScore = fBaseScores[iAttribute];
  ...
  public String globalInfo() {
    return new StringBuilder("This Bayes Network learning algorithm uses a hill climbing algorithm "
    		).append("restricted by an order on the variables.\n\n"
