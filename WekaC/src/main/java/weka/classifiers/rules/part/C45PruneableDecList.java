...
public class C45PruneableDecList extends ClassifierDecList {
   ...
   */
  public C45PruneableDecList(ModelSelection toSelectLocModel, float cf,
  ...
  protected void pruneEnd() {
    ...
    if (Utils.smOrEq(errorsLeaf, errorsTree + 0.1f)) { // +0.1 as in C4.5
      m_isLeaf = true;
      m_sons = null;
   ...
   */
  private float getEstimatedErrorsForTree() {
   ...
   */
  public float getEstimatedErrorsForLeaf() {

    float errors = localModel().distribution().numIncorrect();
