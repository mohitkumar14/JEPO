...
public class ZeroR extends AbstractClassifier implements
  ...
  public void buildClassifier(Instances instances) throws Exception {
    ...
    case Attribute.NOMINAL:
      m_Counts = new float[instances.numClasses()];
    ...
    for (Instance instance : instances) {
      float classValue = instance.classValue();
   ...
   */
  @Override
  public float classifyInstance(Instance instance) {
  ...
  public String toSource(String className) throws Exception {
    ...
    if (m_Counts != null) {
      result.append("    // always predicts label '").append(m_Class.value((int) m_ClassValue)).append("'\n");
    }
    result.append("    return ").append(m_ClassValue).append(";\n");
    result.append("  }\n");
    result.append("}\n");
