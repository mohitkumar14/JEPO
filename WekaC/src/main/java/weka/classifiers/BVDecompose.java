...
public class BVDecompose
  ...
  protected float m_Variance;

  /** The calculated sigma (squared) */
  protected float m_Sigma;
  ...
  public String [] getOptions() {
    ...
    options[current++] = "-x"; options[current++] = String.valueOf(getTrainIterations());
    options[current++] = "-T"; options[current++] = String.valueOf(getTrainPoolSize());
  ...
  public void decompose() throws Exception {
    ...
    float [][] instanceProbs = new float [numTest][numClasses];
