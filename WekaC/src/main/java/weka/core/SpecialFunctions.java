...
public final class SpecialFunctions
  ...
  /** Some constants */
  private static float log2 = (float) Math.log(2);
   ...
   */
  public static float lnFactorial(float x){
   ...
   */
  public static float log2Binomial(float a, float b) {
   ...
   */
  public static float log2Multinomial(float a, float[] bs) {
