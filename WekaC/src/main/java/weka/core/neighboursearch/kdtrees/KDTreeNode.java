...
public class KDTreeNode
   ...
   */
  public KDTreeNode(int nodeNum, int startidx, int endidx, float[][] universe) {
    m_NodeNumber = nodeNum;
    m_Start = startidx; m_End = endidx;
    m_NodeRanges = universe;
  }
   ...
   */
  public KDTreeNode(int nodeNum, int startidx, int endidx, float[][] nodeRanges, float[][] rectBounds) {
    m_NodeNumber = nodeNum;
    m_Start = startidx; m_End = endidx;
