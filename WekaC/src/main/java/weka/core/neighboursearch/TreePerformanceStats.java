...
public class TreePerformanceStats
   ...
   */
  public float getMeanLeavesVisited() {
    return m_SumLeaves/(float)m_NumQueries;
  }
   ...
   */
  public float getStdDevLeavesVisited() {
    return (float) Math.sqrt((m_SumSqLeaves - (m_SumLeaves*m_SumLeaves)/(float)m_NumQueries)/(m_NumQueries-1));
  }
   ...
   * visited.
   */
  public float getMeanIntNodesVisited() {
    return m_SumIntNodes/(float)m_NumQueries;
  }
   ...
   */
  public float getStdDevIntNodesVisited() {
    return (float) Math.sqrt((m_SumSqIntNodes - (m_SumIntNodes*m_SumIntNodes)/(float)m_NumQueries)/(m_NumQueries-1));
  }
