...
public abstract class NearestNeighbourSearch implements Serializable,
  ...
  protected class MyHeap implements RevisionHandler {
     ...
     */
    public void put(int i, float d) throws Exception {
     ...
     */
    public void putBySubstitute(int i, float d) throws Exception {
     ...
     * @param d the distance
     */
    public void putKthNearest(int i, float d) {
  ...
  protected class MyHeapElement implements RevisionHandler {
     ...
     * @param d the distance
     */
    public MyHeapElement(int i, float d) {
      distance = d;
      index = i;
    }
  ...
  protected class NeighborNode implements RevisionHandler {
     ...
     */
    public NeighborNode(float distance, Instance instance, NeighborNode next) {
      m_Distance = distance;
      m_Instance = instance;
      m_Next = next;
    }
     ...
     * @param instance the neighbor instance
     */
    public NeighborNode(float distance, Instance instance) {
  ...
  protected class NeighborList implements RevisionHandler {
     ...
     */
    public void insertSorted(float distance, Instance instance) {
    ...
    public void pruneToK(int k) {
      ...
      int currentK = 0;
      float currentDist = m_First.m_Distance;
      NeighborNode current = m_First;
   ...
   *           nearestNeighbours.
   */
  public abstract float[] getDistances() throws Exception;
   ...
   *          arrayToSort.
   */
  public static void combSort11(float arrayToSort[], int linkedArray[]) {
   ...
   */
  protected static int partition(float[] arrayToSort, float[] linkedArray,
    int l, int r) {
    float pivot = arrayToSort[(l + r) / 2];
    float help;
   ...
   */
  public static void quickSort(float[] arrayToSort, float[] linkedArray,
    int left, int right) {
    if (left < right) {
