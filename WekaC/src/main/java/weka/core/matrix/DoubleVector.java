...
public class DoubleVector implements Cloneable, RevisionHandler {
  ...
  float[] V; // array for internal storage of elements.
   ...
   */
  public DoubleVector(int n, float s) {
    this(n);
    set(s);
  }
   ...
   * @param s the value
   */
  public void set(int i0, int i1, float s) {
   ...
   * @param v the values
   */
  public void set(int i0, int i1, float[] v, int j0) {
    for (int i = i0; i <= i1; i++) {
      V[i] = v[j0 + i - i0];
    }
  }
   ...
   * @param s the value
   */
  public void setPlus(int i, float s) {
    V[i] += s;
  }
   ...
   * @param s the value
   */
  public void setTimes(int i, float s) {
    V[i] *= s;
  }
   ...
   * @return the product
   */
  public float innerProduct(DoubleVector v) {
    if (size() != v.size()) {
   ...
   */
  public float sum2(DoubleVector v) {
    return minus(v).sum2();
  }
   ...
   * @param x the value
   */
  public DoubleVector plus(float x) {
   ...
   * @param x the value
   */
  public DoubleVector plusEquals(float x) {
    for (int i = 0; i < size(); i++) {
      V[i] += x;
    }
    return this;
   ...
   * @param x the value
   */
  public DoubleVector minus(float x) {
    return plus(-x);
  }
   ...
   * @param x the value
   */
  public DoubleVector minusEquals(float x) {
    plusEquals(-x);
    return this;
  }
   ...
   * @return s * v
   */
  public DoubleVector times(float s) {
   ...
   */
  public DoubleVector timesEquals(float s) {
    for (int i = 0; i < size(); i++) {
      V[i] *= s;
    }
    return this;
  ...
  public DoubleVector map(String className, String method) {
    try {
      ...
      for (int i = 0; i < size(); i++) {
        obj[0] = new Float(V[i]);
        w.set(i, Float.parseFloat(m.invoke(null, obj).toString()));
      }
      return w;
    } catch (Exception e) {
      e.printStackTrace();
