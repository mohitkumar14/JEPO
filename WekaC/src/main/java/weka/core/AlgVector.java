...
public class AlgVector 
 ...
 /**
   ...
   */
  public AlgVector(float[] array) {
    
    m_Elements = new float[array.length];
  ...
  public Object clone() throws CloneNotSupportedException {
    ...
    v.m_Elements = new float[numElements()];
   ...
   */
  public final void setElements(float[] elements) {
  ...
  public float[] getElements() {
    ...
    float [] elements = new float[this.numElements()];
    for (int i = 0; i < elements.length; i++) {
  ...
  public Instance getAsInstance(Instances model, Random random) 
	...
	if (model.attribute(i).isNominal()) {
	  int newVal = (int) 
	    (random.nextFloat() * (float) (model.attribute(i).numValues()));
   ...
   */
  public final float dotMultiply(AlgVector b) {
   ...
   * @param s 		the scalar
   */
  public final void scalarMultiply(float s) {
