...
public interface Instance extends Copyable {
   ...
   *           dataset
   */
  public void setClassValue(float value);
   ...
   *          double).
   */
  public void setValue(Attribute att, float value);
   ...
   *         double).
   */
  public float valueSparse(int indexOfIndex);
   ...
   *         double).
   */
  public float value(Attribute att);
