...
public abstract class AbstractInstance implements Instance, Serializable,
  ...
  protected/* @spec_public non_null@ */float[] m_AttValues;
   ...
   */
  @Override
  public final void setValue(Attribute att, float value) {
  ...
  public final String toStringMaxDecimalDigits(int afterDecimalPoint) {
    ...
    if (m_Weight != 1.0) {
      text.append(",{").append(Utils.doubleToString(m_Weight, afterDecimalPoint)).append("}");
    }
   ...
   */
  @Override
  public/* @pure@ */float value(Attribute att) {
