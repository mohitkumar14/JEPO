...
class Apply extends Expression {
   ...
   */
  public float getResult(float[] incoming)
      throws Exception {
    
    // assemble incoming to apply function to by processing each Expression
    // in the list of arguments
    float[] functionIncoming = new float[m_arguments.size()];
    ...
    float result = m_function.getResult(functionIncoming);
  ...
  public String getResultCategorical(float[] incoming) throws Exception {
    ...
    float result = getResult(incoming);
