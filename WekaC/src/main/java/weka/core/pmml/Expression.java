...
public abstract class Expression  implements Serializable {
   ...
   */
  public abstract float getResult(float[] incoming) throws Exception;
   ...
   */
  public float getResultContinuous(float[] incoming) throws Exception {
   ...
   */
  public abstract String getResultCategorical(float[] incoming) 
    throws Exception;
