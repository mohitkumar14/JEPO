...
public class Matrix implements Cloneable, Serializable, RevisionHandler {
   ...
   */
  public Matrix(float[][] array) throws Exception {
   ...
   */
  public final void addElement(int rowIndex, int columnIndex, float value) {
   ...
   */
  public final void setRow(int index, float[] newRow) {
  ...
  public float[] getRow(int index) {
    float[] newRow = new float[this.numColumns()];
    for (int i = 0; i < newRow.length; i++) {
  ...
  public float[] getColumn(int index) {
    float[] newColumn = new float[this.numRows()];
   ...
   */
  public final void setColumn(int index, float[] newColumn) {
   ...
   */
  public final float[] regression(Matrix y, float ridge) {
   ...
   *           provided.
   */
  public final float[] regression(Matrix y, float[] w, float ridge) {
   ...
   */
  public void solve(float[] bb) throws Exception {
    // solve
   ...
   */
  public void eigenvalueDecomposition(float[][] V, float[] d)
    throws Exception {
    ...
    float[] d2 = eig.getRealEigenvalues();
   ...
   */
  protected static float hypot(float a, float b) {
  ...
  public static void main(String[] ops) {
    ...
    float[] first = { 2.3f, 1.2f, 5 };
    float[] second = { 5.2f, 1.4f, 9 };
    float[] response = { 4, 7, 8 };
    float[] weights = { 1, 2, 3 };

    try {
      // test eigenvaluedecomposition
      float[][] m = { { 1, 2, 3 }, { 2, 5, 6 }, { 3, 6, 9 } };
      ...
      float[] coefficients = b.regression(r, 1.0e-8f);
      ...
      coefficients = b.regression(r, weights, 1.0e-8f);
      for (float coefficient : coefficients) {
        System.out.print(coefficient + " ");
      }
      System.out.println();
