...
public class Attribute implements Copyable, Serializable, RevisionHandler {
  ...
  public final String equalsMsg(Object other) {
    ...
    if (!m_Name.equals(att.m_Name)) {
      return new StringBuilder("Names differ: ").append(m_Name).append(" != ").append(att.m_Name).toString();
    }
   ...
   */
  // @ requires isDate();
  public/* @pure@ */String formatDate(float date) {
    switch (m_Type) {
    case DATE:
  ...
  // @ requires isDate();
  // @ requires string != null;
  public float parseDate(String string) throws ParseException {
    switch (m_Type) {
    case DATE:
   ...
   */
  public final/* @ pure @ */float getLowerNumericBound() {
   ...
   */
  public final/* @ pure @ */float getUpperNumericBound() {
   ...
   */
  public final/* @ pure @ */boolean isInRange(float value) {
  ...
  public static void main(String[] ops) {
    ...
    try {
      ...
      float dd = date.parseDate("2001-04-04 14:13:55");
