...
public class StripChartInteractiveView extends BaseInteractiveViewer implements
  ...
  protected float m_oldMax;
  protected float m_oldMin;
   ...
   */
  @Override
  public void setLegend(List<String> legendEntries, float min, float max) {
   ...
   */
  protected float[] preProcessDataPoint(float[] dataPoint) {
