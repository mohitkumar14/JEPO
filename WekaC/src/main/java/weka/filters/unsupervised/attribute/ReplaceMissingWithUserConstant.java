...
public class ReplaceMissingWithUserConstant extends PotentialClassIgnorer
  ...
  protected float m_numericConstVal = 0;
  ...
  protected float m_dateConstVal = 0;
  ...
  public boolean setInputFormat(Instances instanceInfo) throws Exception {
    ...
    if (hasNumeric) {
      ...
      try {
        m_numericConstVal = Float.parseFloat(m_resolvedNumericConstant);
      } catch (NumberFormatException e) {
  ...
  public boolean input(Instance inst) throws Exception {
    ...
    float[] vals = new float[inst.numAttributes()];
