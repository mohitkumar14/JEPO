...
public class DiscreteEstimator extends Estimator implements
  ...
  /** Hold the counts */
  private final float[] m_Counts;

  /** Hold the sum of counts */
  private float m_SumOfCounts;

  /** Initialization for counts */
  private float m_FPrior;
   ...
   */
  public DiscreteEstimator(int nSymbols, float fPrior) {

    m_Counts = new float[nSymbols];
    m_FPrior = fPrior;
