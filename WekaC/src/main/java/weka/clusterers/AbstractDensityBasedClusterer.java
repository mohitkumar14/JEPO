...
public abstract class AbstractDensityBasedClusterer
   ...
   */
  public abstract float[] clusterPriors() 
    throws Exception;
   ...
   * successfully
   */
  public abstract float[] logDensityPerClusterForInstance(Instance instance) 
    throws Exception;
   ...
   */
  public float logDensityForInstance(Instance instance) throws Exception {

    float[] a = logJointDensitiesForInstance(instance);
   ...
   */
  public float[] logJointDensitiesForInstance(Instance inst)
    throws Exception {

    float[] weights = logDensityPerClusterForInstance(inst);
    float[] priors = clusterPriors();
