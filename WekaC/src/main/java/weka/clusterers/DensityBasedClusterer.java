...
public interface DensityBasedClusterer extends Clusterer {
   ...
   */
  float[] clusterPriors() throws Exception;
   ...
   */
  float[] logDensityPerClusterForInstance(Instance instance) throws Exception;
   ...
   * @exception Exception if the density could not be computed successfully
   */
  float logDensityForInstance(Instance instance) throws Exception;
   ...
   */
  float[] logJointDensitiesForInstance(Instance inst) throws Exception;
   ...
   */
  @Override
  float[] distributionForInstance(Instance instance) throws Exception;
}
