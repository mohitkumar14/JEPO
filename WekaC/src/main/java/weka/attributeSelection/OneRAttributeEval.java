...
public class OneRAttributeEval extends ASEvaluation implements
  ...
  public String[] getOptions() {
    ...
    options.add("-F");
    options.add(String.valueOf(getFolds()));
    options.add("-B");
    options.add(String.valueOf(getMinimumBucketSize()));
  ...
  public float evaluateAttribute(int attribute) throws Exception {
    ...
    String[] oneROpts = { "-B", String.valueOf(getMinimumBucketSize()) };
  ...
  public String toString() {
    ...
    if (m_trainInstances == null) {
      ...
      if (m_evalUsingTrainingData) {
        ...
        text.append("").append(getFolds()).append(" fold cross validation for evaluating attributes.");
      }
      text
        .append("\n\tMinimum bucket size for OneR: ").append(getMinimumBucketSize());
    }
