...
public class BestFirst extends ASSearch implements OptionHandler,
  ...
  public class Link2 implements Serializable, RevisionHandler {
     ...
     * Constructor
     */
    public Link2(Object[] data, float mer) {
    ...
    public String toString() {
      return new StringBuilder("Node: ").append(m_data.toString()).append("  ").append(m_merit).toString();
    }
  ...
  public class LinkedList2 extends ArrayList<Link2> {
     ...
     **/
    public void addToList(Object[] data, float mer) throws Exception {
  ...
  public String globalInfo() {
    return new StringBuilder("BestFirst:\n\n")
    	.append( "Searches the space of attribute subsets by greedy hillclimbing ")
    	.append("augmented with a backtracking facility. Setting the number of ")
    	.append("consecutive non-improving nodes allowed controls the level of ")
    	.append("backtracking done. Best first may start with the empty set of ")
    	.append("attributes and search forward, or start with the full set of ")
    	.append("attributes and search backward, or start at any point and search ")
    	.append("in both directions (by considering all possible single attribute ")
    	.append("additions and deletions at a given point).\n").toString();
  }
  ...
  public String[] getOptions() {
    ...
    if (!(getStartSet().equals(""))) {
      options.add("-P");
      options.add(String.valueOf(startSetToString()));
    }
    options.add("-D");
    options.add(String.valueOf(m_searchDirection));
    options.add("-N");
    options.add(String.valueOf(m_maxStale));
  ...
  public String toString() {
    ...
    if (m_starting == null) {
      ...
      BfString.append(startSetToString()).append("\n");
    }
    ...
    BfString
      .append("\tStale search after ").append(m_maxStale).append(" node expansions\n");
    BfString.append("\tTotal number of subsets evaluated: ").append(m_totalEvals).append("\n");
    BfString.append("\tMerit of best subset found: ").append(Utils.doubleToString(Math.abs(m_bestMerit), 8, 3))
    .append("\n");
        ...
        for (i = 0; i < m_numAttribs; i++) {
          ...
          if (z) {
            ...
            if (lookup.containsKey(hashC) == false) {
              ...
              merit = lookup.get(hashC).floatValue();
            }
