...
public class Ranker extends ASSearch implements RankedOutputSearch,
  ...
  private float[] m_attributeMerit;
  ...
  public int[] search(ASEvaluation ASEval, Instances data) throws Exception {
    ...
    m_attributeMerit = new float[m_numAttribs - sl];
    ...
    float[][] tempRanked = rankedAttributes();
  ...
  public float[][] rankedAttributes() throws Exception {
    ...
    float[][] bestToWorst = new float[ranked.length][2];
  ...
  private void determineNumToSelectFromThreshold(float[][] bestToWorst) {
    int count = 0;
    for (float[] element : bestToWorst) {
