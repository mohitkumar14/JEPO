...
public abstract class SingleAssociatorEnhancer extends AbstractAssociator
  ...
  public Enumeration<Option> listOptions() {
    ...
    result.addElement(new Option(new StringBuilder("\tFull name of base associator.\n\t(default: ")
    .append(defaultAssociatorString()).append(")").toString(), "W", 1, "-W"));

    if (m_Associator instanceof OptionHandler) {
      result.addElement(new Option("", "", 0,
    		  new StringBuilder("\nOptions specific to associator ").append(m_Associator.getClass().getName())
    		  .append(":").toString()));
