...
public class FilteredAssociator extends SingleAssociatorEnhancer implements
  ...
  public String globalInfo() {
    return new StringBuilder("Class for running an arbitrary associator on data that has been passed ")
      .append("through an arbitrary filter. Like the associator, the structure of the filter ")
      .append("is based exclusively on the training data and test instances will be processed ")
      .append("by the filter without changing their structure.").toString();
  }
  ...
  public String[] getOptions() {
    ...
    result.add("-F");
    result.add(String.valueOf(getFilterSpec()));

    result.add("-c");
    result.add(String.valueOf(getClassIndex()));
  ...
  public String toString() {
    ...
    if (m_FilteredInstances == null) {
      ...
      result = new StringBuilder("FilteredAssociator using ").append(getAssociatorSpec())
    		  .append(" on data filtered through ").append(getFilterSpec())
    		  .append("\n\nFiltered Header\n").append(m_FilteredInstances.toString())
    		  .append("\n\nAssociator Model\n").append(m_Associator.toString()).toString();
    }
